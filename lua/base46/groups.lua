...
function M.load_faces(base46, config)
  ...
  if config.transparency then
    ...
    if config.plugins.bufferline then
      local background = base46.base_16.base01
  ...
  if config.plugins.markview then
  ...
  if config.plugins.rainbow then
  ...
  if config.plugins.flutterTools then
